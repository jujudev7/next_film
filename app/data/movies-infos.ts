...
const movies: Movie[] = [
  ...
  },
  {
    title: "Le Grand Bleu",
    synopsis:
      "Une plongée dans la rivalité entre deux apnéistes, Enzo et Jacques, explorant leur passion pour l'océan et leur amitié complexe.",
    poster: "le-grand-bleu.jpg",
    duration: "2h48",
    year: 1988,
    director: ["Luc Besson"],
    ...
    category: "film",
    genre: "Drame",
    tags: ["plongée", "océan", "amitié", "compétition"],
  },
  {
    title: "Old Boy",
    synopsis:
      "Après avoir été kidnappé et emprisonné pendant 15 ans sans raison apparente, Oh Dae-su est libéré et cherche à comprendre qui est derrière son calvaire.",
    poster: "old-boy.jpg",
    duration: "2h00",
    year: 2003,
    ...
    category: "film",
    genre: "Thriller",
    tags: ["vengeance", "prison", "psychologique"],
  },
  {
    title: "Date Limite",
    synopsis:
      "Un architecte embarque dans un voyage rocambolesque avec un acteur excentrique pour assister à la naissance de son enfant.",
    poster: "date-limite.jpg",
    duration: "1h35",
    year: 2010,
    ...
    category: "film",
    genre: "Comédie",
    tags: ["voyage", "comédie", "naissance", "road trip"],
  },
  {
    title: "The Truman Show",
    synopsis:
      "Truman Burbank découvre que sa vie est en fait une émission de télé-réalité, où il est filmé en permanence.",
    poster: "the-truman-show.jpg",
    duration: "1h43",
    year: 1998,
    director: ["Peter Weir"],
    ...
    category: "film",
    genre: "Comédie dramatique",
    tags: ["télé-réalité", "surveillance", "liberté"],
  },
  {
    title: "Cube",
    synopsis:
      "Un groupe d'étrangers se réveille dans un labyrinthe de pièces cubiques et doit trouver comment en sortir, face à de nombreux pièges.",
    poster: "cube.jpg",
    duration: "1h30",
    year: 1997,
    director: ["Vincenzo Natali"],
    actors: ["Nicole de Boer", "David Hewlett", "Nicky Guadagni"],
    category: "film",
    genre: "Science-fiction",
    tags: ["survie", "énigme", "piège", "huis clos"],
  },
  {
    title: "D.A.R.Y.L.",
    synopsis:
      "Un jeune garçon doté de capacités extraordinaires découvre qu'il est en fait un androïde créé par les militaires.",
    poster: "daryl.jpg",
    duration: "1h40",
    year: 1985,
    director: ["Simon Wincer"],
    actors: ["Barret Oliver", "Mary Beth Hurt", "Michael McKean"],
    category: "film",
    genre: "Science-fiction",
    tags: ["robot", "enfance", "surdoué", "fuite"],
  },
  {
    title: "Jeux d'Enfants",
    synopsis:
      "Deux amis d'enfance jouent à un jeu de défis toujours plus risqués, jusqu'à ce que leur amour se retrouve en jeu.",
    poster: "jeux-d-enfants.jpg",
    duration: "1h33",
    year: 2003,
    ...
    category: "film",
    genre: "Romance",
    tags: ["amour", "enfance", "défi", "romantisme"],
  },
  {
    ...
    poster: "l-histoire-sans-fin.jpg",
    duration: "1h42",
    year: 1984,
    ...
    category: "film",
    genre: "Fantasy",
    tags: ["fantaisie", "aventure", "magie", "quête"],
  },
  {
    ...
    poster: "asterix-obelix-mission-cleopatre.jpg",
    duration: "1h47",
    year: 2002,
    director: ["Alain Chabat"],
    actors: ["Gérard Depardieu", "Christian Clavier", "Monica Bellucci"],
    category: "film",
    genre: "Comédie",
    tags: ["bd", "humour", "numerobis", "construction"],
  },
  {
    title: "Le Huitième Jour",
    synopsis:
      "Un homme d'affaires rencontre Georges, un homme trisomique, et cette rencontre bouleverse sa vie.",
    poster: "le-huitieme-jour.jpg",
    duration: "1h58",
    year: 1996,
    director: ["Jaco Van Dormael"],
    actors: ["Daniel Auteuil", "Pascal Duquenne"],
    category: "film",
    genre: "Drame",
    tags: ["handicap", "amitié", "trisomie", "acceptation"],
  },
  {
    title: "Melancholia",
    synopsis:
      "Alors qu'une planète menaçante s'approche de la Terre, deux sœurs sont confrontées à des crises personnelles.",
    ...
    category: "film",
    genre: "Drame",
    tags: ["fin du monde", "psychologie", "famille"],
  },
  {
    ...
    poster: "2001-l-odyssee-de-l-espace.jpg",
    duration: "2h29",
    year: 1968,
    ...
    category: "film",
    genre: "Science-fiction",
    tags: ["espace", "IA", "mystère", "philosophie"],
  },
  {
    title: "Duel",
    synopsis:
      "Un homme est traqué par un mystérieux camionneur qui semble décidé à le tuer, sur une route désertique.",
    poster: "duel.jpg",
    duration: "1h30",
    year: 1971,
    ...
    category: "film",
    genre: "Thriller",
    tags: ["route", "poursuite", "tension", "survie"],
  },
  {
    title: "Jurassic Park",
    synopsis:
      "Des scientifiques recréent des dinosaures et ouvrent un parc d'attractions qui tourne au cauchemar.",
    ...
    category: "film",
    genre: "Aventure",
    tags: ["dinosaures", "science", "parc", "survie"],
  },
  {
    title: "Les Dents de la Mer",
    synopsis:
      "Un requin tueur terrorise une petite station balnéaire, et un chef de police doit l'affronter.",
    poster: "les-dents-de-la-mer.jpg",
    duration: "2h04",
    year: 1975,
    director: ["Steven Spielberg"],
    actors: ["Roy Scheider", "Richard Dreyfuss", "Robert Shaw"],
    category: "film",
    genre: "Horreur",
    tags: ["requin", "plage", "terreur", "survie"],
  },
  {
    title: "Saw",
    synopsis:
      "Deux hommes se réveillent enchaînés dans une pièce et doivent résoudre des énigmes mortelles pour survivre.",
    poster: "saw.jpg",
    duration: "1h43",
    year: 2004,
    director: ["James Wan"],
    ...
    category: "film",
    genre: "Horreur",
    tags: ["horreur", "puzzle", "psychopathe", "survie"],
  },
  {
    title: "Conclave",
    synopsis:
    ...
    category: "film",
    genre: "Drame",
    tags: ["drame", "religion", "pape", "thriller"],
  },
  {
    title: "Mustang",
    synopsis:
    ...
    category: "film",
    genre: "Drame",
    tags: ["drame", "féminisme", "liberté", "Turquie"],
  },
  {
    title: "En Fanfare",
    synopsis:
    ...
    category: "film",
    genre: "Comédie dramatique",
    tags: ["musique", "orchestre", "famille"],
  },
  {
    title: "Les Évadés",
    synopsis:
    ...
    category: "film",
    genre: "Drame",
    tags: ["prison", "amitié", "espoir", "évasion"],
  },
  {
    title: "La Fracture",
    synopsis:
      "Raf et Julie, un couple en crise, se retrouvent à l'hôpital dans un service d'urgence débordé. Leurs chemins croisent celui de Yann, un gilet jaune blessé et en colère. Un film sous fond de fractures sociales et politiques.",
    poster: "la-fracture.jpg",
    duration: "1h38",
    year: 2021,
    ...
    category: "film",
    genre: "Drame",
    tags: ["hôpital", "gilets jaunes", "couple", "société"],
  },
  {
    title: "Riverboom",
    synopsis:
