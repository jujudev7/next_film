...
const series: Serie[] = [
  ...
  },
  {
    title: "Cœurs Noirs",
    synopsis:
      "Une unité d'élite des forces spéciales françaises en mission en Irak se retrouve confrontée à des dilemmes moraux et personnels alors qu'ils luttent pour accomplir leur mission.",
    poster: "coeurs-noirs.jpg",
    duration: "52 min",
    year: 2023,
    ...
    episodes: 6,
    genre: "Action, Drame",
    tags: ["militaire", "action", "guerre", "drame"],
  },
  {
    title: "Osmosis",
    synopsis:
      "Dans un futur proche, une technologie permet de trouver l'âme sœur parfaite en analysant le cerveau, mais l'amour peut-il vraiment être prédit scientifiquement ?",
    poster: "osmosis.jpg",
    duration: "52 min",
    year: 2019,
    yearEnd: 2019,
    ...
    tags: ["futuriste", "romance", "IA", "dystopie"],
  },
  {
    title: "Omniscient",
    synopsis:
      "Dans une ville où les citoyens sont surveillés en permanence par des drones, une jeune femme enquête sur un meurtre que les autorités ont ignoré.",
    poster: "omniscient.jpg",
    duration: "40 min",
    year: 2020,
    yearEnd: 2020,
    director: ["Pedro Aguilera"],
    actors: ["Carla Salle", "Sandra Corveloni", "Jonathan Haagensen"],
    category: "serie",
    seasons: 1,
    episodes: 6,
    genre: "Science-fiction, Thriller",
    tags: ["surveillance", "dystopie", "crime"],
  },
  {
    title: "Inside Man",
    synopsis:
      "Un criminologue incarcéré aide à résoudre des enquêtes criminelles compliquées, tout en ayant ses propres motivations cachées.",
    poster: "inside-man.jpg",
    duration: "60 min",
    year: 2022,
    yearEnd: 2022,
    ...
    tags: ["prison", "psychologie", "mystère", "crime"],
  },
  {
    title: "I Am Not Okay With This",
    synopsis:
      "Une adolescente navigue entre les complexités de l'adolescence et la découverte de pouvoirs surnaturels qui la dépassent.",
    poster: "i-am-not-okay-with-this.jpg",
    duration: "30 min",
    year: 2020,
    yearEnd: 2020,
    ...
    tags: ["adolescence", "pouvoirs", "mystère"],
  },
  {
    title: "Mon amie Adèle",
    synopsis:
      "Une jeune femme s'embarque dans une relation compliquée avec son patron et sa femme mystérieuse, révélant un dangereux triangle amoureux.",
    poster: "mon-amie-adele.jpg",
    duration: "50 min",
    year: 2021,
    yearEnd: 2021,
    director: ["Steve Lightfoot"],
    actors: ["Simona Brown", "Eve Hewson", "Tom Bateman"],
    category: "serie",
    seasons: 1,
    episodes: 6,
    genre: "Thriller, Drame",
    tags: ["psychologique", "mystère", "drame"],
  },
  {
    title: "Gossip Girl",
    synopsis:
      "Les élèves privilégiés d'une école privée new-yorkaise voient leurs vies dévoilées par un mystérieux blogueur.",
    poster: "gossip-girl.jpg",
    duration: "42 min",
    year: 2007,
    yearEnd: 2012,
    ...
    episodes: 121,
    genre: "Drame, Romance",
    tags: ["ragots", "élite", "romance", "New York"],
  },
  {
    title: "L'Effondrement",
    synopsis:
      "Une série d'anthologie sur les conséquences de l'effondrement de la société moderne, abordant la survie dans un monde sans infrastructures.",
    poster: "l-effondrement.jpg",
    duration: "15-20 min",
    year: 2019,
    yearEnd: 2019,
    ...
    tags: ["dystopie", "crise", "survie", "effondrement"],
  },
  {
    title: "Alice in Borderland",
    synopsis:
      "Un jeune homme et ses amis se retrouvent dans un Tokyo désert, forcés de jouer à des jeux mortels pour survivre.",
    ...
    tags: ["survie", "dystopie", "jeux mortels", "suspense"],
  },
  {
    title: "Drôle",
    synopsis:
      "Quatre comédiens en herbe tentent de percer dans le stand-up parisien, jonglant entre succès et échecs personnels.",
    poster: "drole.jpg",
    duration: "45 min",
    year: 2022,
    yearEnd: 2022,
    director: ["Fanny Herrero"],
    actors: ["Younès Boucif", "Elsa Guedj", "Mariama Gueye", "Jean Siuen"],
    category: "serie",
    seasons: 1,
    episodes: 6,
    genre: "Comédie, Drame",
    tags: ["humour", "stand-up", "scène", "comédiens"],
  },
  {
    title: "La Petite Fille sous la neige",
    synopsis:
      "Une journaliste déterminée enquête sur la disparition mystérieuse d'une petite fille, révélant des secrets profondément enfouis.",
    poster: "la-petite-fille-sous-la-neige.jpg",
    duration: "50 min",
    year: 2023,
    ...
    episodes: 6,
    genre: "Thriller, Policier",
    tags: ["disparition", "journalisme", "enquête"],
  },
];
