...
const series: Serie[] = [
  ...
  },
  {
    title: "Criminal",
    synopsis:
      "Plongée au cœur des salles d'interrogatoire, où l'on suit à chaque épisode les confrontations tendues entre suspects et enquêteurs. Une série policière européenne qui compte une version en Allemagne, en Espagne, en Grande-Bretagne et en France.",
    poster: "criminal.jpg",
    duration: "40-45 min",
    seasons: 2,
    episodes: 12,
